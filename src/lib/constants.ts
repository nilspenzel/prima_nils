...
export const MAX_TRAVEL_MS = 1000 * MAX_TRAVEL_SECONDS;
export const MAX_PASSENGER_WAITING_TIME_PICKUP = 60000 * 10;
export const MAX_PASSENGER_WAITING_TIME_DROPOFF = 60000 * 10;
